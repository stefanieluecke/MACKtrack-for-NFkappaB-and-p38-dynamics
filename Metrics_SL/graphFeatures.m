...
for i = 1:n
    data_for_bar_nfkb(i) = ID(i).metrics.responders_fraction_nfkb;
    data_for_bar_ktr(i) = ID(i).metrics.responders_fraction_ktr;
end
...
%todo add dose labels as parameter or get from folder name or at least add IDs
