...
responder_colormap = [([113 115 118]/255);[0.4660 0.6740 0.1880];[0, 0.4470, 0.7410];[0.9290 0.6940 0.1250]];

%responder_colormap = divergingmap(0:1/1023:1,[14 28 77]/255,[158 27 2]/255);%opens utilities function to make diverging color map with these specified rgb codes and the sepcified step size
%responder_colormap(1,:) = [0.1 0.1 0.1]; %?
