function [metrics,aux, graph, info, measure] = nfkb_ratio_ktr_ratio_metrics(id,varargin)
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
[graph, info, measure] = filter_nfkb_ratio_ktr_ratio(id,'MinLifetime',MinLifetime,...
...
%{ 
%take this KTR oscillation section out for now, because it gives problems
when using ratios
