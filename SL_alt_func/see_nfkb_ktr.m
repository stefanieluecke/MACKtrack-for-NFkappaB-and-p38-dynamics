function [graph, info, measure] = see_nfkb_ktr(id,varargin)
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
addParameter (p, 'Source', 'Stefanie'); %? see whether I need to include this
...
if graph_flag
    ...
    figs.a = figure('name','ColormapStack_NFkB');
    ...
    % Colormap stack: creates heatmap of filtered trajectories using order determined above (graph.order)
    figs.b = figure('name','ColormapStack_KTR');
    set(figs.a,'Position', [500 700 1200 600])
