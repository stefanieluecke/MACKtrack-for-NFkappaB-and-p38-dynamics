function [metrics,aux, graph, info, measure] = nfkb_ktr_ratio_metrics_test(id,varargin)
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
[graph, info, measure] = filter_nfkb_ktr_ratio_test(id,'MinLifetime',MinLifetime,...
